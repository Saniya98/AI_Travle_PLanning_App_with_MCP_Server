...
This project extends the Multi-Agent Travel Planning System by integrating MCP (Model Context Protocol) servers for real-time flight and weather data.


**GitHub Repository:**  
https://github.com/Saniya98/AI_Travle_PLanning_App_with_MCP_Server
